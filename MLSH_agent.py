import numpy as np
from Subpolicies import Subpolicies
...
class MLSH_agent:
    ...
    def get_next_master_action(self, master_state, evaluation_episode=False):
        if evaluation_episode:
            discrete_action = self.master_policy.get_action_deterministically(master_state,self.use_maml)
        else:
            discrete_action = self.master_policy.get_action_nondeterministically(master_state,self.use_maml)
