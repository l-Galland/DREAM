...
class ReplayBuffer:
    ...
    def __init__(self, observation_space,action_space, capacity=5000):
        self.observation_space = observation_space
        self.action_space = action_space
        transition_type_str = self.get_transition_type_str(observation_space,action_space)
    ...
    def get_transition_type_str(self, observation_space,action_space):
